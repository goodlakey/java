...
public class ConnectionDriver {
    private static ConnectionDriver serviceDb = null;
    private static MysqlDataSource dataSource;

    private ConnectionDriver(String dbName, String user, String password) {
    ...
    public static void init(String dbName, String user, String password) {
        ...
        serviceDb = new ConnectionDriver(dbName, user, password);
    }
